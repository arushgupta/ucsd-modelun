...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { award: @award.award, is_active: @award.is_active, page_description: @award.page_description, subheading: @award.subheading }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { award: @award.award, is_active: @award.is_active, page_description: @award.page_description, subheading: @award.subheading }
    assert_redirected_to award_path(assigns(:award))
  end
